...
/*    void (*image_rotation_set)              (void *data, void *image); */
   ...
   Eina_Bool (*font_text_props_info_update) (void *data, Evas_Font_Instance *fi, const Eina_Unicode *text, Evas_Text_Props *intl_props, size_t pos, size_t len, Evas_Text_Props_Mode mode);
